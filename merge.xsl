...
<xsl:stylesheet
    ...
    <xsl:variable name="STAR" select="document('file:///home/basile/rasp-newsfeed/STAR/star_test.xml')" />
    <xsl:variable name="WEATHER" select="document('file:///home/basile/rasp-newsfeed/Weather/weather.xml')" />
    <html>
    <head>
       <meta charset="utf-8"/>
       <meta http-equiv="refresh" content="60" />
       <link rel="stylesheet" media="screen and (min-width: 400px) and (max-width: 1000024px)" href="./Weather/style.css" type="text/css" />
       <link rel="stylesheet" media="screen and (min-width: 400px) and (max-width: 1000024px)" href="./STAR/style.css" type="text/css" />

       
        <title>Rasp-Newsfeed</title>
    ...
    <body>  
		...
		<section id="weather">
			<div id="timeline"/>
			<xsl:apply-templates select="$WEATHER/response/hourly_forecast"/>
		</section>
    </body>
    </html>
    </xsl:template>
